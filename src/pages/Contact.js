  ...
  const data = [
    {
      icon: <FaMapMarkerAlt />,
      title: "Address",
      description: "Nguyen Van Cu, Ninh Kieu District, Can Tho City",
    },
    {
      icon: <MailOutlined />,
      title: "Email",
      description: "dimuonnoi@gmail.com",
    },
    {
      icon: <PhoneOutlined />,
      title: "Phone",
      description: "091 702 32 43",
    },
    {
    ...
    <div>
      ...
      <Row style={{ width: "85%", margin: "5% auto" }} gutter={[32, 32]}>
        ...
        <Col xs={24} lg={14}>
          ...
          <p style={{ margin: "10px 0", fontSize: "14px", color: "gray" }}>
            If you have any questions, you can send us a request, and we will
